...
public class Calendar {
	...
	private static void makeCalendar(String[] layout, String month, String year, Calendar format) {
	...
	public void main(String[] args) {
		...
		//makes the calendar
		Calendar format = new Calendar();
		makeCalendar(layout, monthName, date[0], format);
	}
}